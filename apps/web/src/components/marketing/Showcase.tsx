      ...
      <div className="grid items-stretch lg:grid-cols-2">
        <Parallax speed={30} className="relative min-h-[380px] lg:min-h-[640px]">
          <div className="absolute inset-0">
            ...
            />
            <div className="absolute inset-0 via-transparent to-transparent bg-linear-to-t from-ink-950/30 lg:hidden" />
          </div>
        </Parallax>

        <div className="relative flex items-center bg-white px-6 py-16 sm:px-12 lg:-ml-16 lg:rounded-l-[2.5rem] lg:py-0 lg:shadow-2xl lg:shadow-ink-900/10 dark:bg-ink-800 dark:lg:shadow-black/40">
          <div className="mx-auto max-w-lg lg:mx-0 lg:ml-16">
            ...
            <dl className="grid grid-cols-3 gap-4 pt-8 mt-10 border-t border-ink-200 dark:border-ink-800">
              {stats.map((s, i) => (
                <Reveal key={s.label} delay={i * 0.1}>
                  <dt className="text-2xl font-bold font-display text-brand-600 dark:text-brand-300">
            ...
            <Reveal delay={0.2}>
              <Button
                variant="outline"
                size="lg"
                className="mt-9 h-auto rounded-xl border-ink-300 px-6 py-3.5 text-base text-ink-700 hover:bg-ink-50 dark:border-ink-700 dark:bg-ink-700 dark:text-ink-200 dark:hover:bg-ink-600"
