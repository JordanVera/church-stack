          ...
          <div className="space-y-14">
            {steps.map((s, i) => (
              <Reveal key={s.n} delay={i * 0.1} className="relative flex gap-6 pl-0 sm:gap-8">
                <span className="relative z-10 grid h-12 w-12 shrink-0 place-items-center rounded-full border-2 border-brand-500 bg-slate-50 font-display text-sm font-bold text-brand-600 dark:border-brand-400 dark:bg-slate-900 dark:text-brand-300 sm:h-14 sm:w-14">
                  {s.n}
                </span>
                <div className="pt-1">
