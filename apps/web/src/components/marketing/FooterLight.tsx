...
export default function FooterLight() {
  return (
    <footer className="relative overflow-hidden bg-ink-50 pt-20 pb-10 text-ink-950">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <Reveal className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-ink-200 pt-8 text-xs text-ink-500 sm:flex-row">
